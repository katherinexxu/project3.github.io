...
function showBooks() {
  ...
  books.forEach((book) => {
    ...
    var bookContainer = document.createElement("div");
        ...
        bookName.innerText = book.fields.Name;
        ...
        var bookImages = document.createElement("img");
        bookImages.classList.add("book-Images");
        bookImages.src = book.fields.Image[0].url;
        bookContainer.append(bookImages);
